          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="p-6 bg-indigo-50 dark:bg-indigo-900/10 rounded-[32px] border border-indigo-100/30 dark:border-indigo-500/10 text-sm font-black text-indigo-600 dark:text-indigo-400 italic">
